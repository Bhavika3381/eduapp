...
const CourseDetailScreen = ({ route }) => {
  ...
  const [selectedVideo, setSelectedVideo] = useState(null); // Track selected chapter video
  ...
  const chapters = [
    ...
    { id: '4', title: 'State and Props in React', duration: '25 min', progress: 0, videoUrl: 'https://videos.pexels.com/video-files/4354035/4354035-sd_640_360_25fps.mp4' },
    { id: '5', title: 'Building a Small Project', duration: '30 min', progress: 0, videoUrl: 'https://videos.pexels.com/video-files/5473797/5473797-sd_960_506_25fps.mp4' },
    { id: '6', title: 'Testing & Debugging', duration: '18 min', progress: 0, videoUrl: 'https://videos.pexels.com/video-files/3141210/3141210-sd_640_360_25fps.mp4' },
    { id: '7', title: 'Deployment & Best Practices', duration: '22 min', progress: 0, videoUrl: 'https://videos.pexels.com/video-files/8721923/8721923-sd_960_506_25fps.mp4' },
  ];
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.details}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.value}>{course.fees}</Text>
        </View>

        <View style={styles.viewersContainer}>
          <FontAwesome name="eye" size={16} color="#0052D4" />
          <Text style={styles.viewers}>{course.viewers} viewers</Text>
        </View>
       

        <TouchableOpacity style={styles.enrollButton}>
          <LinearGradient colors={['#0052D4', '#4364F7', '#6FB1FC']} style={styles.gradientButton}>
      ...
      <View style={styles.chaptersContainer}>
        <Text style={styles.chaptersTitle}>Course Chapters</Text>
         <View style={styles.progressBar}>
          <Text style={styles.progressTexts}>Overall Progress: {overallProgress.toFixed(1)}%</Text>
          <Svg width="100%" height="10">
            <Rect x="0" y="0" width="100%" height="10" fill="#ddd" rx="5" />
            <Rect x="0" y="0" width={`${overallProgress}%`} height="10" fill="#0052D4" rx="5" />
          </Svg>
        </View>
        <FlatList 
          data={chapters}
          renderItem={({ item }) => (
            <View>
                ...
                <View style={styles.chapterCard}>
                  <View style={styles.chapterTextContainer}>
                    ...
                    <Text style={styles.chapterDuration}>
                      <FontAwesome name="clock-o" size={14} color="#666" /> {item.duration}
                    </Text>
                  </View>
                  <View style={styles.progressContainer}>
                    <Svg width={40} height={40}>
                      ...
                      <Circle
                        ...
                        strokeDashoffset={(1 - item.progress / 100) * Math.PI * 2 * 18}
                        strokeLinecap="round"
                      />
                    </Svg>
              ...
              {/* Show video only for the selected chapter */}
...
const styles = StyleSheet.create({
  ...
  progressBarContainer: { marginVertical: 10 },
  progressText: { fontSize: 14, fontWeight: 'bold', color: '#0052D4', marginBottom: 5 },
  ...
  chapterNumber: { fontSize: 14, fontWeight: 'bold', color: '#0052D4' },
  chapterTitle: { fontSize: 16, fontWeight: 'bold', color: '#333', marginTop: 3 },
  chapterDuration: { fontSize: 12, color: '#666', marginTop: 3 },
  ...
  progressText: { position: 'absolute', fontSize: 12, fontWeight: 'bold', color: '#0052D4',marginTop:"10px", },
