...
//   let finalAmount = (totalAmount - discount).toFixed(2);
...
//       <TouchableOpacity style={styles.paymentOption} onPress={() => setSelectedPayment('Credit Card')}>
//         <FontAwesome name="credit-card" size={20} color={selectedPayment === 'Credit Card' ? '#FF5722' : '#333'} />
//         <Text style={styles.paymentText}>Credit Card</Text>
//       </TouchableOpacity>
//       <TouchableOpacity style={styles.paymentOption} onPress={() => setSelectedPayment('PayPal')}>
//         <FontAwesome name="paypal" size={20} color={selectedPayment === 'PayPal' ? '#FF5722' : '#333'} />
//         <Text style={styles.paymentText}>PayPal</Text>
//       </TouchableOpacity>
//       <TouchableOpacity style={styles.paymentOption} onPress={() => setSelectedPayment('Google Pay')}>
//         <FontAwesome name="google-wallet" size={20} color={selectedPayment === 'Google Pay' ? '#FF5722' : '#333'} />
